...
export class MapManager {
            ...
            div.innerHTML = `
                <div id="mainControlsDiv" style="padding: 5px; background: white;">
                    ...
                    <br>
                        ...
                        <div style="display: none; align-items: center; margin: 0; padding: 0; box-shadow: none; border: none; background: none;">
                        ...
                        <div id="routeFilterContainer" style="display: none; align-items: center; margin: 0; padding: 0; box-shadow: none; border: none; background: none;">
        ...
        setTimeout(() => {
            try {
                ...
                const updateFilterVisibility = () => {
                    ...
                    // Route filter sempre oculto
                    if (routeFilterContainer) routeFilterContainer.style.display = 'none';
                ...
                // Garantir que Route filter sempre fique oculto
    ...
    setupDrawing() {
        ...
        // Override readableArea to display km² consistently when drawing
        if (L && L.GeometryUtil && !L.GeometryUtil.__routeCrafterKm2Patch) {
            L.GeometryUtil.__routeCrafterKm2Patch = true;
            ...
            L.GeometryUtil.readableArea = function(area, units, precision) {
                ...
                if (!units || units === 'metric') {
                    ...
                    const decimals = typeof precision === 'number' ? precision : (sqKm >= 10 ? 2 : 3);
                    return `${sqKm.toFixed(decimals)} km²`;
                }
                return originalReadableArea(area, units, precision);
            };
        }
