...
export class RoutingManager {
    constructor(mapManager) {
        ...
        this.completedRoutePolyline = null;
        this.routeDirectionLayer = null;
    ...
    startAnimation() {
        ...
        this.resetRouteVisuals();
        if (this.routePoints && this.routePoints.length > 0) {
            this.fullRoutePolyline = L.polyline(this.routePoints, {
                color: '#64b5f6',
                weight: 4,
                opacity: 0.5,
                dashArray: '8 6'
    ...
    updateAnimationFrame() {
        ...
        if (!this.completedRoutePolyline) {
            this.completedRoutePolyline = L.polyline(routeUntilCurrent, {
                color: '#00c853',
                weight: 6,
                opacity: 0.9
            }).addTo(this.map);
    ...
    addRouteDirectionLayer(points) {
        if (!points || points.length < 2) {
            return;
        }
        if (typeof L === 'undefined' || typeof L.polylineDecorator !== 'function') {
            return;
        }
        if (this.routeDirectionLayer) {
            this.map.removeLayer(this.routeDirectionLayer);
            this.routeDirectionLayer = null;
        }
        this.routeDirectionLayer = L.polylineDecorator(points, {
            patterns: [{
                offset: '5%',
                repeat: 60,
    ...
    resetRouteVisuals() {
        ...
        if (this.completedRoutePolyline) {
            this.map.removeLayer(this.completedRoutePolyline);
            this.completedRoutePolyline = null;
        }
