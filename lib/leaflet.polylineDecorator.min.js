...
(function (global, factory) {
  ...
  L.PolylineDecorator = L.LayerGroup.extend({
    ...
    _addSymbol: function (options) {
      ...
      if (!symbol || typeof symbol.initialize !== 'function') {
        return;
      }
  ...
  L.Symbol.ArrowHead = L.Marker.extend({
    initialize: function (position, options) {
      ...
      L.Marker.prototype.initialize.call(this, position, { icon: L.divIcon(iconOptions) });
    },
    ...
    _createArrow: function () {
      if (!this._map || !this._position || !this._position.bearing) {
        return;
      }
      ...
      var bearing = this._position.bearing * Math.PI / 180;
      var size = this._pixelSize;
      var angle = this._headAngle;
      var point = this._map.latLngToLayerPoint(this._position);
